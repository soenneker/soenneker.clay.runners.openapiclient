...
using Soenneker.Clay.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Clay.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Clay:ClientGenerationUrl"] ?? "https://developers.clay.com/openapi.json";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Clay OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "ClayOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
